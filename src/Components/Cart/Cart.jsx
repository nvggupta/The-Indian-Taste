      ...
      <div className="flex flex-col md:flex-row w-full md:w-3/4 lg:w-1/2 gap-6">
        ...
        <div className="flex-1 mt-6 md:mt-0 md:ml-6 p-4 border border-gray-200 rounded-lg shadow-lg">
          ...
          <div className="flex justify-between mb-2">
            ...
            <p className="font-bold text-lg">₹{(totalAmount + totalAmount * 0.1 + 50).toFixed(2)}</p>
          </div>
          <div className="mt-4">
            ...
            <button className="w-full mt-4 py-2 bg-purple-700 text-white font-bold rounded-lg hover:bg-purple-800 transition">
              Proceed to Payment
            </button>
          </div>
        </div>
